...
- `e3bf9fca8a2b465d538921f608df08a341ef560f` - `docs: refresh README and companion test guidance`
  - Expands the project README and documents the `foo.sscript` + `foo.test.sscript` companion-file pattern, including import rules, capability placement, and harness fallback behavior.
...
- `0b55f789273e465c1fdd357cc937507b4372d1a5` - `stdlib: add SemanticScript standard library self-tests`
  - Added 28 standalone `stdlib_sem` modules, a stdlib sanity smoke program, and a test harness that compiles and runs every stdlib module.
