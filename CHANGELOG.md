...
- `1b533ef283db271859f5b4e44a0398bd67dc766d` - `stdlib: move smokes into companion test files`
  - Moves inline stdlib smoke / unit-test programs into sibling `*.test.as` files, keeps implementation modules focused on exported operations, and updates `tests/test_stdlib.py` to prefer companions including `stdio.test.as`. Verified with `python AgentScript\tests\test_stdlib.py` (28/28 passing).
- `e3bf9fca8a2b465d538921f608df08a341ef560f` - `docs: refresh README and companion test guidance`
  - Expands the project README and documents the `foo.as` + `foo.test.as` companion-file pattern, including import rules, capability placement, and harness fallback behavior.
- `7e56e2db6171bf8dccfe484f9481eacc0995af0a` - `docs: add SemanticScript rebrand migration plan`
  - Adds a granular per-file `TODO.md` checklist for the AgentScript -> SemanticScript rebrand: `.sscript` / `.sem`, `semsc`, `semlint`, semantic tape wording, docs, tooling, VS Code, tests, and final legacy-string gates.
...
- `91561198c90860d9af01f98302ae37779b29f72e` - `vscode-agentscript: 0.1.6 -> 0.1.9 with aslint2 integration`
...
- `bf4ff1b4f581779c5f974a22e59a45cd8b16c9f5` - `stdlib: extended unit tests for inttypes.as smoke`
...
- `a718da92d3e05480586086e79be461890081f084` - `stdlib: extended unit tests for iso646.as smoke`
...
- `4778ff01962c793984ce1510b0b13377d532efb2` - `stdlib: extended unit tests for assert.as smoke`
...
- `8887a08323d7fdd80c41ef93b105ddcca13f40ba` - `stdlib: extended unit tests for random.as / stdlib.as / time.as smokes`
...
- `b8f90485655fa82999e829f0e933962fd192a756` - `stdlib: extended unit tests for bool.as and memory.as smokes`
...
- `1b3050d35c431768b6f048aacf987cf42b7457aa` - `stdlib: every stdlib_as file passes aslint2 with zero diagnostics`
...
- `700892ef2d23b1f17f75f8a80e2bd80f89ec314c` - `linter: add aslint2 with relaxed primitive-type equivalence`
...
- `7454ff25dd8dba9f9f951f647752ae3b0de01c85` - `tests: align stdio.as expected output with stdlib operation rename`
...
- `4e9d0f2ea1d920de20398001ca899575b2387812` - `tooling: support refined AgentScript syntax in VS Code`
...
- `22f1987d1ee7a863221c8b69e63bc65b52cddd5b` - `stdlib: tighten AS self-test names`
...
- `e72e69c2e1571d697e23ef545920b679e2eb4870` - `tests: add AS compiler feature coverage`
...
- `884558946756a43f01d4ce65fe2745636762cd9c` - `examples: add AgentScript programs and language oracles`
  - Added AgentScript sample programs plus JavaScript and Python comparison/oracle programs.
- `79db538dbd354e161795bd2a421fdd790e03130b` - `tooling: add VS Code AgentScript extension`
...
- `3c1e67b6b9a192b2de27cd450fd0f0c07075f69c` - `bootstrap: add input-scaled AS compiler stages`
...
- `e08c30a24c7b8e94fad01ae8d776ccabefaba3ad` - `tests: add AS compiler parity coverage`
  - Added compiler unit tests, AS-written compiler parity checks, and ignored generated parity build outputs.
- `71936861237db6e531c1f3dc9953084dd9257a95` - `docs: document AgentScript 1.0 toolchain`
...
- `2cc6d4adb286fd45c3539b1921a9a97704bb63e0` - `compiler: support typed AS helper operations`
...
- `0b55f789273e465c1fdd357cc937507b4372d1a5` - `stdlib: add AS standard library self-tests`
...
- `240b409303d2765630836500d0c4c8dfa316e4e8` - `docs: refresh AgentScript project state`
