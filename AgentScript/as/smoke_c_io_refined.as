...
#
# Migration of as/smoke_c_io.as to refined syntax. Demonstrates c.puts,
# c.printf, and c.getenv via the AgentScript libc surface.
...
domainLiteral smokeIoBannerText CNullTerminatedByteString "=== smoke_c_io ==="
domainLiteral smokeIoPutsDemoLineText CNullTerminatedByteString "via c.puts: hello from puts"
domainLiteral smokeIoPrintfFiveCharFormatText CNullTerminatedByteString "via c.printf: %c%c%c%c%c\n"
domainLiteral smokeIoGetenvProbeName CNullTerminatedByteString "PATH"
domainLiteral smokeIoGetenvReportFormatText CNullTerminatedByteString "via c.getenv: PATH is reachable (sentinel=%d)\n"
...
domainLiteral helloAsciiCapitalH CSignedInt32 72
domainLiteral helloAsciiLowercaseE CSignedInt32 101
domainLiteral helloAsciiLowercaseLFirst CSignedInt32 108
domainLiteral helloAsciiLowercaseLSecond CSignedInt32 108
domainLiteral helloAsciiLowercaseO CSignedInt32 111
domainLiteral getenvCallReachedSentinel CSignedInt32 1
