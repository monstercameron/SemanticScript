...
#
# Migration of as/hello_via_helper.as to refined syntax. Same behavior —
# main calls writeStandardOutputLine which writes "Hello, World!".

section program.helloViaHelperRefined

project HelloViaHelperRefined
target console
runtime AgentRuntime 0.1
entry console main

section program.helloViaHelperRefined.errors

error MainError
errorCase MainError ConsoleWriteFailed ConsoleWriteError

section program.helloViaHelperRefined.literals
...
section program.helloViaHelperRefined.operations
