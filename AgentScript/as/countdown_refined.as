...
#
# Migration of as/countdown.as to refined syntax. Same behavior — print
# 5, 4, 3, 2, 1 each on their own line — but rewritten to use the
# transformer-friendly verb forms from experiments/refined_syntax_example.as.
#
...
#
# Verify identical behavior to as/countdown.as via:
#   python compiler/ascc.py as/countdown_refined.as --emit-ir /tmp/c.ll
