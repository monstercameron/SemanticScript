...
#
# Migration of as/smoke_c_classifiers.as to refined syntax. Verify the
...
domainLiteral formatLineText CNullTerminatedByteString "isnan(%g)=%d isinf(%g)=%d isfinite(%g)=%d isnormal(%g)=%d signbit(%g)=%d fpclassify(%g)=%d\n"
domainLiteral probeValue CFloat64 3.14
domainLiteral zeroValue CFloat64 0.0
