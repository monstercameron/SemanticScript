# ============================================================
# AGENTSCRIPT STANDARD LIBRARY TESTS: byte-buffer array helpers
# ============================================================
#
# # rationale: companion test file for stdlib_as/array.as. Imports
#   the array module and exercises every operation it exports —
#   sum / min / max / contains / count / reverse — with boundary
...
#   entry console main. The implementation file stdlib_as/array.as
