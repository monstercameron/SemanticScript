# ============================================================
# AGENTSCRIPT STDLIB TESTS: compare
# ============================================================
#
# Companion smoke + extended unit tests for stdlib_as/compare.as.
# Imports the compare module and asserts every ordering / equality
# predicate plus reflexive / irreflexive / symmetry / tolerance
# property tests over CSignedInt64 and CFloat64 inputs.
#
...
bind compareLessResult CSignedInt32 assertCompareLessThanCall
...
bind compareFloatResult CSignedInt32 assertCompareFloatCall
...
run cmpGreaterCall
bind cmpGreaterResult CSignedInt32 cmpGreaterCall
...
run cmpEqCall
bind cmpEqResult CSignedInt32 cmpEqCall
...
bind cmpFloatGreaterResult CSignedInt32 cmpFloatGreaterCall
...
run cmpFloatEqCall
bind cmpFloatEqResult CSignedInt32 cmpFloatEqCall
