...
entry console isAsciiDecimalDigitCode

# This is a pure-module (library) file: it exports operations
# consumed by other programs (notably stdlib_as/ctype.test.as which
...
# Canonical ASCII boundary literals â€” declared once at module scope so
...
invariant isAsciiBlankCode "Strict subset of isAsciiWhitespaceCode â€” excludes LF, VT, FF, CR."
