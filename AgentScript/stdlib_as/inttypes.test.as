# ============================================================
# AGENTSCRIPT STDLIB TESTS: inttypes
# ============================================================
#
# Companion smoke + extended unit tests for stdlib_as/inttypes.as.
# Imports the inttypes module and asserts each helper (abs / div
# quotient / div remainder / parse binary / parse octal) plus the
# Euclidean property q·d + r == n.
#
