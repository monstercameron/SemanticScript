...
entry console readProcessCpuClockTicks

# This is a pure-module (library) file: it exports operations
# consumed by other programs (notably stdlib_as/time.test.as which
...
#   output type with Result encoding â€” the compiler can't
...
# bound error value (the pointer-as-i32 NULL = 0) as the return â€”
...
purpose convertSecondsToWholeHours "Returns secondCount / 3600 â€” the number of whole hours represented."
...
purpose convertSecondsToWholeMinutes "Returns secondCount / 60 â€” the number of whole minutes represented."
