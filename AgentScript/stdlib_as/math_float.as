...
#   in the emitted IR â€” no c.sqrt, c.exp, c.log, c.fabs, c.pow, c.sin,
...
#   over its declared domain â€” Result wrappers are dropped because
...
project StdMathFloat
target console
runtime AgentRuntime 0.1
entry console absoluteFloat64

# This is a pure-module (library) file: it exports operations
# consumed by other programs (notably stdlib_as/math_float.test.as
...
purpose squareRootFloat64 "sqrt(x) for x >= 0 via Newton's method. Returns 0.0 for x <= 0 (no NaN here yet â€” that needs IEEE special-value support)."
...
# denominator: (2k)(2k+1) â€” both ints.
const twoIsn I64 2
...
# compare-to-zero result is intentionally discarded â€” its only
