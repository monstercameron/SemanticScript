"""Freeze the semanticscript toolchain into a standalone executable (X-025).

Bundles semanticscript.py + llvmlite (with its LLVM binaries) + the std/sigs/runtime data
...
semanticscript.py). Output: dist/semanticscript[.exe].
"""
import os
import subprocess
import sys
