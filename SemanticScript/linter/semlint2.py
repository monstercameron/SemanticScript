...
from semlint import (  # type: ignore  # noqa: E402
    CallFact,
    OperationFact,
    ProgramFacts,
    SourceLine,
...
# precede production use. See semlint2 design notes for the proposed grammar.
SEM_RECORD_HEADER = (
    ...
    "# syntax surface is landed. See semlint2 design notes.\n"
)
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    if not resolvedPaths:
        print("semlint2: no .sscript or .sem files matched", file=sys.stderr)
        return 2
    ...
    for resolvedPath in resolvedPaths:
        try:
            ...
            print(f"semlint2: failed to read {resolvedPath}: {readError}", file=sys.stderr)
            return 2
