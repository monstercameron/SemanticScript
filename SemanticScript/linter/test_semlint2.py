...
""")
        ...
        self.assertEqual(diagnostic.severity, semlint2.Severity.ERROR)
...
""")
        ...
        self.assertEqual(diagnostic.tier, semlint2.Tier.T4_STYLE)
        self.assertEqual(diagnostic.severity, semlint2.Severity.INFO)
        self.assertTrue(any(
