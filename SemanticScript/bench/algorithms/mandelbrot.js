...
// iteration-count checksum is identical across all four languages. The order
// of the float operations must stay exactly as written to keep results
// bit-identical. Wrapped in main() so V8 JIT-optimizes the hot loops.
