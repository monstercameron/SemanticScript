...
- `smoke_c_*` programs for low-level C ABI and runtime coverage.
...
samples. The `smoke_c_*` files intentionally exercise low-level `c.*` targets;
normal app-facing examples should move toward SemanticScript API calls.
